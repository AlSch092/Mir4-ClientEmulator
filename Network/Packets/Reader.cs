...
namespace Mir4ClientEmulator.Network.Packets
{
    public class Reader
    {
        ...
        private readonly int header_length = 15;
        ...
        public Reader(byte[] packet, int length)
        {
        ...
        {
            var final = new byte[m_buffer.Length - offset - header_length];
            Buffer.BlockCopy(m_buffer, offset + header_length, final, 0, m_buffer.Length - offset - header_length);
            return final;
        }
    }
}
